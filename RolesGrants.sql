...
BEGIN
    ...
    EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE, DELETE ON AGENT TO MANAGER_ROLE';
     EXECUTE IMMEDIATE 'GRANT CONNECT, SELECT, INSERT ON POLICYHOLDER TO MANAGER_ROLE';
    ...
    EXECUTE IMMEDIATE 'GRANT CONNECT, SELECT, INSERT ON POLICYHOLDER TO ADJUSTER_ROLE';
